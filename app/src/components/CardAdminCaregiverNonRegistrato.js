...
function CardAdminCaregiverNonRegistrato(props) {
    ...
    const invioMail = async () => {
        return await fetch("http://localhost:8080/comunicazione/invioMailCaregiverNonRegistrato/"+props.idUtente, {
    ...
    return(
        <div className="cardUtente" ref={container}>
            ...
            <div className="contenitorePulsantiUtenteCard" ref={bottoniUtente}>
                <button className="button" onClick={invioMail} >
                    Invio Mail
                </button>
...
export default CardAdminCaregiverNonRegistrato;
