...
import java.net.URL;
public class SystemTestingRegistrazioneCaregiverCodiceFiscaleErratoTest {
  ...
  @Test
  public void systemTestingRegistrazioneCaregiverCodiceFiscaleErrato() {
    ...
    driver.findElement(By.id("codiceFiscale")).sendKeys("djhbawhbdjwd");
