...
import java.net.URL;
public class SystemTestingRegistrazioneCaregiverNumeroTelefonoNonValidoTest {
  ...
  @Test
  public void systemTestingRegistrazioneCaregiverNumeroTelefonoNonValido() {
    ...
    driver.findElement(By.name("numeroTelefono")).sendKeys("3917056365");
    driver.findElement(By.name("genere")).click();
    driver.findElement(By.name("genere")).sendKeys("M");
    {
      WebElement element = driver.findElement(By.name("dataDiNascita"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).clickAndHold().perform();
    }
    {
      WebElement element = driver.findElement(By.cssSelector(".contenitoreRegistrazioneForm"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).release().perform();
    }
    driver.findElement(By.cssSelector(".contenitoreRegistrazioneForm")).click();
