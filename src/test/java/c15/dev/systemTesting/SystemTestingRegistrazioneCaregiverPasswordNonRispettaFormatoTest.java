...
import java.net.URL;
public class SystemTestingRegistrazioneCaregiverPasswordNonRispettaFormatoTest {
  ...
  @Test
  public void systemTestingRegistrazioneCaregiverPasswordNonRispettaFormato() {
    ...
    driver.findElement(By.name("confermaPassword")).sendKeys("ciao");
