...
import java.net.URL;
public class SystemTestingRegistrazioneCaregiverDataNascitaErrataTest {
  ...
  @Test
  public void systemTestingRegistrazioneCaregiverDataNascitaErrata() {
    ...
    driver.findElement(By.name("dataDiNascita")).click();
    driver.findElement(By.name("dataDiNascita")).sendKeys("0002-07-30");
    driver.findElement(By.name("dataDiNascita")).sendKeys("0020-07-30");
    driver.findElement(By.name("dataDiNascita")).sendKeys("0202-07-30");
    driver.findElement(By.name("dataDiNascita")).sendKeys("2025-07-30");
