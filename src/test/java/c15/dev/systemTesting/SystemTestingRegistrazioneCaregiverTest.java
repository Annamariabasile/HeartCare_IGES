...
import java.net.URL;
public class SystemTestingRegistrazioneCaregiverTest {
  ...
  @Test
  public void systemTestingRegistrazioneCaregiver() {
    driver.get("http://localhost:3000/registrazioneCaregiver?idPaziente=1&idCaregiver=75");
