...
import java.net.URL;
public class SystemTestingRegistrazioneCaregiverGenereErratoTest {
  ...
  @Test
  public void systemTestingRegistrazioneCaregiverGenereErrato() {
    ...
    driver.findElement(By.name("genere")).sendKeys("Z");
